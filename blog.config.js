...
const BLOG = {
  ...
  THEME: process.env.NEXT_PUBLIC_THEME || 'hexo', // 현재 테마는 themes 폴더 아래에서 지원하는 모든 테마를 찾을 수 있습니다. 테마 이름은 example, fukasawa, gitbook, heo, hexo, landing, matery, medium, next , nobelium , plog , simple
